...
// Begin JS library code
  ...
  sendMessage:function (p, name, payload) {
        ...
        try {
          getWasmTableEntry(cb)(p.id, namePtr, dataPtr);
        } finally {
          _free(namePtr);
          _free(dataPtr);
        }
  ...
  completeEval:function (panelId, requestId, failed, text) {
        ...
        var cb = HUI.evalCb;
        try {
          getWasmTableEntry(cb)(panelId, requestId, ptr, failed ? 1 : 0);
        } finally {
          _free(ptr);
        }
      },
  ...
  function _Hiccup_ElemAddClass(h, cPtr) { var e = HUI.el(h); if (e) e.classList.add(UTF8ToString(cPtr)); }

  function _Hiccup_ElemBlur(h) { var e = HUI.el(h); if (e && e.blur) e.blur(); }

  function _Hiccup_ElemClick(h) { var e = HUI.el(h); if (e && e.click) e.click(); }

  function _Hiccup_ElemEnsureId(h) { var e = HUI.el(h); return HUI.cstr(e ? HUI.ensureId(e) : ''); }

  function _Hiccup_ElemFocus(h) { var e = HUI.el(h); if (e && e.focus) e.focus({ preventScroll: true }); }

  
  function _Hiccup_ElemGetAttr(h, nPtr) { var e = HUI.el(h); var v = e ? e.getAttribute(UTF8ToString(nPtr)) : null; return HUI.cstr(v === null ? '' : v); }

  
  function _Hiccup_ElemGetBoolProp(h, nPtr) { var e = HUI.el(h); return (e && !!e[UTF8ToString(nPtr)]) ? 1 : 0; }

  function _Hiccup_ElemGetBounds(h, outPtr) {
      var e = HUI.el(h);
      var o = outPtr >> 2;
  ...
  function _Hiccup_ElemGetHtml(h) { var e = HUI.el(h); return HUI.cstr(e ? e.innerHTML : ''); }

  
  function _Hiccup_ElemGetProp(h, nPtr) { var e = HUI.el(h); var v = e ? e[UTF8ToString(nPtr)] : undefined; return HUI.cstr(v === undefined || v === null ? '' : String(v)); }

  
  function _Hiccup_ElemGetStyle(h, nPtr) { var e = HUI.el(h); return HUI.cstr(e ? getComputedStyle(e).getPropertyValue(UTF8ToString(nPtr)) : ''); }

  function _Hiccup_ElemGetText(h) { var e = HUI.el(h); return HUI.cstr(e ? e.textContent : ''); }

  
  function _Hiccup_ElemHasAttr(h, nPtr) { var e = HUI.el(h); return (e && e.hasAttribute(UTF8ToString(nPtr))) ? 1 : 0; }

  
  function _Hiccup_ElemHasClass(h, cPtr) { var e = HUI.el(h); return (e && e.classList.contains(UTF8ToString(cPtr))) ? 1 : 0; }

  
  function _Hiccup_ElemInsertHtml(h, wherePtr, sPtr) {
      var e = HUI.el(h); if (e) e.insertAdjacentHTML(UTF8ToString(wherePtr), UTF8ToString(sPtr));
    }

  
  function _Hiccup_ElemMatches(h, selPtr) { var e = HUI.el(h); try { return (e && e.matches(UTF8ToString(selPtr))) ? 1 : 0; } catch (ex) { return 0; } }

  function _Hiccup_ElemParent(h) { var e = HUI.el(h); return HUI.handle(e && e.parentElement && !e.parentElement.classList.contains('hui-content') ? e.parentElement : null); }

  
  function _Hiccup_ElemQuery(h, selPtr) {
  ...
  function _Hiccup_ElemRelease(h) { HUI.releaseHandle(h); }

  function _Hiccup_ElemRemove(h) { var e = HUI.el(h); if (e && e.parentNode) e.parentNode.removeChild(e); HUI.releaseHandle(h); }

  
  function _Hiccup_ElemRemoveAttr(h, nPtr) { var e = HUI.el(h); if (e) e.removeAttribute(UTF8ToString(nPtr)); }

  
  function _Hiccup_ElemRemoveClass(h, cPtr) { var e = HUI.el(h); if (e) e.classList.remove(UTF8ToString(cPtr)); }

  function _Hiccup_ElemScrollIntoView(h) { var e = HUI.el(h); if (e && e.scrollIntoView) e.scrollIntoView({ block: 'nearest' }); }

  
  function _Hiccup_ElemSetAttr(h, nPtr, vPtr) { var e = HUI.el(h); if (e) e.setAttribute(UTF8ToString(nPtr), UTF8ToString(vPtr)); }

  
  function _Hiccup_ElemSetBoolProp(h, nPtr, v) { var e = HUI.el(h); if (e) e[UTF8ToString(nPtr)] = !!v; }

  
  function _Hiccup_ElemSetHtml(h, sPtr) { var e = HUI.el(h); if (e) e.innerHTML = UTF8ToString(sPtr); }

  
  function _Hiccup_ElemSetProp(h, nPtr, vPtr) { var e = HUI.el(h); if (e) e[UTF8ToString(nPtr)] = UTF8ToString(vPtr); }

  
  function _Hiccup_ElemSetStyle(h, nPtr, vPtr) { var e = HUI.el(h); if (e) e.style.setProperty(UTF8ToString(nPtr), UTF8ToString(vPtr)); }

  
  function _Hiccup_ElemSetText(h, sPtr) { var e = HUI.el(h); if (e) e.textContent = UTF8ToString(sPtr); }

  function _Hiccup_ElemShowModal(h, v) {
  ...
  function _Hiccup_ElemToggleClass(h, cPtr, force) { var e = HUI.el(h); if (e) e.classList.toggle(UTF8ToString(cPtr), force < 0 ? undefined : !!force); }

  function _Hiccup_Free(ptr) { if (ptr) _free(ptr); }

  function _Hiccup_GetCanvasInfo(outPtr) {
      var c = HUI.canvas;
      var o = outPtr >> 2;
  ...
  function _Hiccup_GetFeatures() {
      return HUI.cstr(JSON.stringify(HUI.features || {}));
    }

  function _Hiccup_Init(backend, linear, forceOverlay, debug, eventCb, messageCb, evalCb) {
      HUI.eventCb = eventCb;
  ...
  function _Hiccup_PanelAnnounce(id, textPtr, assertive) { var p = HUI.panel(id); if (p) HUI.announce(p, UTF8ToString(textPtr), !!assertive); }

  function _Hiccup_PanelBindGPUTexture(id, ptr) { var p = HUI.panel(id); if (p) { p.gpuPtr = ptr; p.dirty = true; HUI.requestPaint(); } }

  function _Hiccup_PanelCreate(w, h) { return HUI.createPanel(w, h); }

  function _Hiccup_PanelCreateGLTexture(id) { var p = HUI.panel(id); return p ? HUI.allocGLTexture(p) : 0; }

  function _Hiccup_PanelDestroy(id) { HUI.destroyPanel(id); }

  
  function _Hiccup_PanelEval(id, codePtr) {
  ...
  function _Hiccup_PanelEvalAsync(id, codePtr, requestId) {
      var p = HUI.panel(id);
  ...
  function _Hiccup_PanelGetTextureSize(id, outPtr) {
      var p = HUI.panel(id);
      HEAP32[outPtr >> 2] = p ? p.texW : 0;
      HEAP32[(outPtr >> 2) + 1] = p ? p.texH : 0;
    }

  function _Hiccup_PanelInvalidate(id) { var p = HUI.panel(id); if (p) { p.dirty = true; HUI.requestPaint(); } }

  function _Hiccup_PanelIsReady(id) { return HUI.panel(id) ? 1 : 0; }

  
  function _Hiccup_PanelListen(id, typePtr, enabled) { var p = HUI.panel(id); if (p) HUI.listen(p, UTF8ToString(typePtr), !!enabled); }

  function _Hiccup_PanelSetBlockInput(id, block) { var p = HUI.panel(id); if (p) HUI.setBlockInput(p, !!block); }

  
  function _Hiccup_PanelSetCss(id, cssPtr) { var p = HUI.panel(id); if (p) HUI.setCss(p, UTF8ToString(cssPtr)); }

  function _Hiccup_PanelSetGeometry(id, matPtr) {
      var p = HUI.panel(id); if (!p) return;
      HUI.setGeometry(p, HEAPF32.subarray(matPtr >> 2, (matPtr >> 2) + 16));
    }

  
  function _Hiccup_PanelSetHtml(id, htmlPtr) { var p = HUI.panel(id); if (p) HUI.setHtml(p, UTF8ToString(htmlPtr)); }

  function _Hiccup_PanelSetMipmaps(id, v) { var p = HUI.panel(id); if (p) { p.mipmaps = !!v; p.dirty = true; } }

  function _Hiccup_PanelSetPointerMode(id, mode) {
      var p = HUI.panel(id); if (!p) return;
      p.el.setAttribute('data-hui-pointer', mode === 0 ? 'panel' : (mode === 1 ? 'children' : 'none'));
    }

  function _Hiccup_PanelSetPremultiplied(id, v) { var p = HUI.panel(id); if (p) { p.premultiply = !!v; p.dirty = true; } }

  function _Hiccup_PanelSetPreventSubmit(id, v) { var p = HUI.panel(id); if (p) p.preventSubmit = !!v; }

  function _Hiccup_PanelSetResolutionScale(id, scale) { var p = HUI.panel(id); if (p) p.scale = Math.max(0.25, Math.min(4, scale || 1)); }

  function _Hiccup_PanelSetSize(id, w, h) { var p = HUI.panel(id); if (p) HUI.setSize(p, w, h); }

  function _Hiccup_PanelSetVisible(id, v) { var p = HUI.panel(id); if (p) HUI.setVisible(p, !!v); }

  function _Hiccup_PanelTakeUpdated(id) { var p = HUI.panel(id); if (!p || !p.updated) return 0; p.updated = false; return 1; }

  
  function _Hiccup_Query(id, selPtr) {
  ...
  function _Hiccup_QueryAll(id, selPtr) {
      var p = HUI.panel(id); if (!p) return HUI.cstr('');
      var out = [];
      try {
  ...
  function _Hiccup_SetGeometryMode(mode) {
      HUI.geometryMode = mode | 0;
      for (var id in HUI.panels) HUI.panels[id].lastMatrix = null; // re-apply with the new strategy
    }

  function _Hiccup_SetUpdateMode(mode) { HUI.updateMode = mode | 0; }

  function _Hiccup_Update() { HUI.update(); }
...
var wasmImports = {
  ...
  /** @export */
  Hiccup_ElemAddClass: _Hiccup_ElemAddClass,
  /** @export */
  Hiccup_ElemBlur: _Hiccup_ElemBlur,
  /** @export */
  Hiccup_ElemClick: _Hiccup_ElemClick,
  /** @export */
  Hiccup_ElemEnsureId: _Hiccup_ElemEnsureId,
  /** @export */
  Hiccup_ElemFocus: _Hiccup_ElemFocus,
  /** @export */
  Hiccup_ElemGetAttr: _Hiccup_ElemGetAttr,
  /** @export */
  Hiccup_ElemGetBoolProp: _Hiccup_ElemGetBoolProp,
  /** @export */
  Hiccup_ElemGetBounds: _Hiccup_ElemGetBounds,
  /** @export */
  Hiccup_ElemGetHtml: _Hiccup_ElemGetHtml,
  /** @export */
  Hiccup_ElemGetProp: _Hiccup_ElemGetProp,
  /** @export */
  Hiccup_ElemGetStyle: _Hiccup_ElemGetStyle,
  /** @export */
  Hiccup_ElemGetText: _Hiccup_ElemGetText,
  /** @export */
  Hiccup_ElemHasAttr: _Hiccup_ElemHasAttr,
  /** @export */
  Hiccup_ElemHasClass: _Hiccup_ElemHasClass,
  /** @export */
  Hiccup_ElemInsertHtml: _Hiccup_ElemInsertHtml,
  /** @export */
  Hiccup_ElemMatches: _Hiccup_ElemMatches,
  /** @export */
  Hiccup_ElemParent: _Hiccup_ElemParent,
  /** @export */
  Hiccup_ElemQuery: _Hiccup_ElemQuery,
  /** @export */
  Hiccup_ElemRelease: _Hiccup_ElemRelease,
  /** @export */
  Hiccup_ElemRemove: _Hiccup_ElemRemove,
  /** @export */
  Hiccup_ElemRemoveAttr: _Hiccup_ElemRemoveAttr,
  /** @export */
  Hiccup_ElemRemoveClass: _Hiccup_ElemRemoveClass,
  /** @export */
  Hiccup_ElemScrollIntoView: _Hiccup_ElemScrollIntoView,
  /** @export */
  Hiccup_ElemSetAttr: _Hiccup_ElemSetAttr,
  /** @export */
  Hiccup_ElemSetBoolProp: _Hiccup_ElemSetBoolProp,
  /** @export */
  Hiccup_ElemSetHtml: _Hiccup_ElemSetHtml,
  /** @export */
  Hiccup_ElemSetProp: _Hiccup_ElemSetProp,
  /** @export */
  Hiccup_ElemSetStyle: _Hiccup_ElemSetStyle,
  /** @export */
  Hiccup_ElemSetText: _Hiccup_ElemSetText,
  /** @export */
  Hiccup_ElemShowModal: _Hiccup_ElemShowModal,
  /** @export */
  Hiccup_ElemToggleClass: _Hiccup_ElemToggleClass,
  /** @export */
  Hiccup_Free: _Hiccup_Free,
  /** @export */
  Hiccup_GetCanvasInfo: _Hiccup_GetCanvasInfo,
  /** @export */
  Hiccup_GetFeatures: _Hiccup_GetFeatures,
  /** @export */
  Hiccup_Init: _Hiccup_Init,
  /** @export */
  Hiccup_PanelAnnounce: _Hiccup_PanelAnnounce,
  /** @export */
  Hiccup_PanelBindGPUTexture: _Hiccup_PanelBindGPUTexture,
  /** @export */
  Hiccup_PanelCreate: _Hiccup_PanelCreate,
  /** @export */
  Hiccup_PanelCreateGLTexture: _Hiccup_PanelCreateGLTexture,
  /** @export */
  Hiccup_PanelDestroy: _Hiccup_PanelDestroy,
  /** @export */
  Hiccup_PanelEval: _Hiccup_PanelEval,
  /** @export */
  Hiccup_PanelEvalAsync: _Hiccup_PanelEvalAsync,
  /** @export */
  Hiccup_PanelGetTextureSize: _Hiccup_PanelGetTextureSize,
  /** @export */
  Hiccup_PanelInvalidate: _Hiccup_PanelInvalidate,
  /** @export */
  Hiccup_PanelIsReady: _Hiccup_PanelIsReady,
  /** @export */
  Hiccup_PanelListen: _Hiccup_PanelListen,
  /** @export */
  Hiccup_PanelSetBlockInput: _Hiccup_PanelSetBlockInput,
  /** @export */
  Hiccup_PanelSetCss: _Hiccup_PanelSetCss,
  /** @export */
  Hiccup_PanelSetGeometry: _Hiccup_PanelSetGeometry,
  /** @export */
  Hiccup_PanelSetHtml: _Hiccup_PanelSetHtml,
  /** @export */
  Hiccup_PanelSetMipmaps: _Hiccup_PanelSetMipmaps,
  /** @export */
  Hiccup_PanelSetPointerMode: _Hiccup_PanelSetPointerMode,
  /** @export */
  Hiccup_PanelSetPremultiplied: _Hiccup_PanelSetPremultiplied,
  /** @export */
  Hiccup_PanelSetPreventSubmit: _Hiccup_PanelSetPreventSubmit,
  /** @export */
  Hiccup_PanelSetResolutionScale: _Hiccup_PanelSetResolutionScale,
  /** @export */
  Hiccup_PanelSetSize: _Hiccup_PanelSetSize,
  /** @export */
  Hiccup_PanelSetVisible: _Hiccup_PanelSetVisible,
  /** @export */
  Hiccup_PanelTakeUpdated: _Hiccup_PanelTakeUpdated,
  /** @export */
  Hiccup_Query: _Hiccup_Query,
  /** @export */
  Hiccup_QueryAll: _Hiccup_QueryAll,
  /** @export */
  Hiccup_SetGeometryMode: _Hiccup_SetGeometryMode,
  /** @export */
  Hiccup_SetUpdateMode: _Hiccup_SetUpdateMode,
  /** @export */
  Hiccup_Update: _Hiccup_Update,
  /** @export */
